function generateHTML(table_name, due_date, total_water, total_electricity, water_cost, electricity_cost, total_cost) {
...
//${table_name}${due_date}${total_water}${total_electricity}${water_cost}${electricity_cost}${total_cost}